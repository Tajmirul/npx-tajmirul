...
const questions = [
    {
        ...
        choices: [
            ...
            },
            {
                ...
                value: () => {
                    const resumeLink =
                        'https://me-back.toinfinite.dev/public/uploads/1675714840082-resume-tajmirul-react.pdf';
                    ...
                    let pipe = request(resumeLink).pipe(
                        fs.createWriteStream(`./${resumeFileName}.pdf`),
                    );
...
const data = {
    ...
    facebook:
        chalk.gray('https://www.facebook.com/') + chalk.blue('akhand.tajmirul'),
